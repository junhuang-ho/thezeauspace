...
//       addressesSuperTokens
//     );
//     diamondCutFacet = await ethers.getContractAt("Cut", diamondAddress);
//     diamondLoupeFacet = await ethers.getContractAt("Loupe", diamondAddress);
//     accessControlFacet = await ethers.getContractAt(
//       "AccessControl",
//       diamondAddress
//     );
//     accessUtility = await ethers.getContractAt("Utility", diamondAddress);
//     automateFacet = await ethers.getContractAt("Automate", diamondAddress);
//     streamSetupFacet = await ethers.getContractAt(
//       "StreamSetup",
//       diamondAddress
//     );
//     streamControlFacet = await ethers.getContractAt(
//       "StreamControl",
//       diamondAddress
//     );
//     // TODO: add more as diamond contract expands
//   });

//   it("should have N facets -- call to facetAddresses function", async () => {
//     for (const address of await diamondLoupeFacet.facetAddresses()) {
//       addresses.push(address);
//     }

//     assert.equal(addresses.length, 7); // TODO: increase this number as diamond contract expands
//   });
...
//     assert.equal(
//       addresses[2],
//       await diamondLoupeFacet.facetAddress("0x52a9c8d7")
//     );
//     assert.equal(
//       addresses[3],
//       await diamondLoupeFacet.facetAddress("0x6f9fb98a")
//     );
//     assert.equal(
//       addresses[4],
//       await diamondLoupeFacet.facetAddress("0xbb6bd765")
//     );
//     assert.equal(
//       addresses[5],
//       await diamondLoupeFacet.facetAddress("0x7555060c")
//     );
//     assert.equal(
//       addresses[6],
//       await diamondLoupeFacet.facetAddress("0xe4bddf68")
//     );
//     // TODO: add assert as diamond contract expands
//   });
...
//       "supportsInterface(bytes4)",
//     ]);
//     const testFacetAddress = addresses.at(-1);
//     tx = await diamondCutFacet.diamondCut(
//       [
//         {
...
//       throw Error(`Diamond upgrade failed: ${tx.hash}`);
//     }
//     result = await diamondLoupeFacet.facetFunctionSelectors(addresses.at(-2));
...
//         action: FacetCutAction.Add,
//         functionSelectors: getSelectors(accessUtility),
//       },
//       {
//         facetAddress: addresses[4],
//         action: FacetCutAction.Add,
//         functionSelectors: getSelectors(automateFacet),
//       },
//       {
//         facetAddress: addresses[5],
//         action: FacetCutAction.Add,
//         functionSelectors: getSelectors(streamSetupFacet),
//       },
//       {
//         facetAddress: addresses[6],
//         action: FacetCutAction.Add,
//         functionSelectors: getSelectors(streamControlFacet),
//       },
//       {
...
//       },
//       // TODO: add more as diamond control expands
//     ];
//     tx = await diamondCutFacet.diamondCut(
//       cut,
//       ethers.constants.AddressZero,
...
//     assert.equal(facetAddresses.length, 9); // TODO: add more as diamond control expands
//     assert.equal(facets.length, 9); // TODO: add more as diamond control expands
