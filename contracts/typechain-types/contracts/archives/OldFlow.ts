...
export interface OldFlowInterface extends utils.Interface {
  functions: {
    ...
    "withdrawSuperTokens(address[],uint256[])": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "withdrawSuperTokens",
    values: [PromiseOrValue<string>[], PromiseOrValue<BigNumberish>[]]
  ): string;
...
export interface OldFlow extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OldFlowInterface;
